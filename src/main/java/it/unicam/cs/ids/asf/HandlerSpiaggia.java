...
public class HandlerSpiaggia {
    ...
    public void aggiungiOmbrellone() {
        ...
        if (this.confermaOperazione())
            ...
            System.out.println("Operazioni annullate");    //modificare il caso d'uso e diagramma se vogliamo messaggio output
    }
    ...
    void ottieniVistaSpiaggia(ArrayList<ArrayList<Ombrellone>> vistaSpiaggiaCorrente) {
